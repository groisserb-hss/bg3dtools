"""
Spectral filtering for functional map refinement.

Provides L1/L2 and Frobenius norm based optimization functors
for refining functional correspondence matrices.
"""
