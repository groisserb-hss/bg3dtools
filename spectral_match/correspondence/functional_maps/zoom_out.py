"""
Zoom-out refinement for functional maps.

Iteratively increases the spectral resolution of a functional map
while refining point-to-point correspondences via nearest-neighbor
assignment in the spectral domain.
"""
...
class zoomout_refinement:
    ...
    def iteration(self, C, dk):
        ...
        C = util.orthogonal_procrustes(y.T, x.T).T
        return C
