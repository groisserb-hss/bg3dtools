"""
Assignment functors for product manifold filtering.

Provides elastic and degenerate assignment strategies used during
iterative correspondence refinement on the product manifold.
"""
