"""
Degenerate assignment problem solver.

Solves rectangular linear assignment problems with feasibility
constraints using OR-Tools linear programming.
"""
...
def degenerate_assignment(C: np.array, feasible: np.array) -> np.array:
    ...
    # print(info)
    status = solver.Solve()
    X = np.zeros((n1, n2), dtype=np.int64)
